...
# Status Report: plan_<PLAN_ID>_task_<TASK_ID>_status

**Plan**: `plans/plan_<PLAN_ID>.txt`
**Task**: `<TASK_ID>`
**Type**: <!-- TEST_CREATION | IMPLEMENTATION | REFACTORING | EPIC | DIAGNOSTIC_TEST_CREATION -->
...
**Parent Plan Task**: `<TASK_ID>` <!-- from plan_<PLAN_ID>.txt -->
